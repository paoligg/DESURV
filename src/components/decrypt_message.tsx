...
const DecryptStringComponent: React.FC<DecryptStringComponentProps> = ({ encryptedText }) => {
...
const handleDecryptClick = async () => {
    ...
    try {
      ...
      const decrypted: ArrayBuffer = await decryptMessage(privateKey, encryptedBytes);
...
export default DecryptStringComponent;
...
async function decryptMessage(privateKey: CryptoKey, ciphertext: ArrayBuffer): Promise<ArrayBuffer> {
